...
<div className="bg-slate-50 rounded-md border border-slate-300 p-2">
  ...
  <div className="text-[10px] space-y-1">
    ...
    {p.otvaranje && (
      <div>{t("Otvaranje")}: {t(p.otvaranje)}</div>
    )}

    {p.roletna && (
      <div>{t("Roletna")}: {t(p.roletna)}</div>
    )}
  ...
  <div className="rounded p-1">
    ...
    <div className="rounded p-1 text-xs">
      ...
      <div className="space-y-1">
        ...
        <div>
          {t("Otvaranje")}: <strong>{t(p.otvaranje || "")}</strong>
        </div>
        ...
        <div>
          {t("Roletna")}: <strong>{t(p.roletna || "")}</strong>
        </div>
...
{activeTab === "Uputstva" && loggedUser?.role === "ADMIN" && (
  <div className="p-4">
    ...
    <div className="sticky top-[80px] z-30 bg-white border-b shadow-sm py-3 mb-4">
...
>
...

  {
    ...
    items: [
      ...
      "Ušteda vremena",
      "Ponude i radne liste izrađuju se brzo, pregledno i bez ručnog računanja.",
      "Manje grešaka",
      "Automatski obračuni smanjuju mogućnost grešaka u dimenzijama i cenama.",
...

  {
    ...
    items: [
      ...
      "Administrator može da podešava profile, ispune, okove, roletne, komarnike, dodatne elemente, tehničke parametre, cene, formule, korisnike i jezike.",
      "PVC i ALU sistemi",
